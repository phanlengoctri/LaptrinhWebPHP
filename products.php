        ...
        <?php if (!empty($products)): ?>
            <?php foreach ($products as $product): ?>
                <div class="product">
                    ...
                    <a class="detail-button" href="product-detail.php?id=<?php echo $product['id']; ?>">Xem chi tiết</a>
                    <a class="add-to-card" href="card.php?add_to_card=<?php echo $product['id']; ?>" onclick="addToCart(event, <?php echo $product['id']; ?>)">Thêm vào giỏ hàng</a>
