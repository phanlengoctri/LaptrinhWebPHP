...
session_start(); // Bắt đầu session để lấy thông tin user đăng nhập
...
<div class="content">
    <header>
        <div class="logo">
            <a href="admin_home.php"><img src="image/Logo/cropped-678.png"></a>
        </div>

        <div class="category">
            <ul>
                <li class="category-item">
                    <a class="category-list" href="maneger_product.php">Quản lí sản phẩm</a>
                </li>
                <li class="category-item">
                    <a class="category-list" href="add_product.php">Thêm sản phẩm</a>
                </li>
                <li class="category-item">
                    <a class="category-list" href="orders_management.php">Quản lí đơn hàng</a>
                </li>
            </ul>
        </div>    
        ...
        <div class="user">
            ...
            <div class="avatar-container">
                ...
                <div class="dropdown-menu" id="dropdownMenu">
                    <a href="account_admin.php" class="icon-account"><i class="fa-solid fa-user"></i> Account</a>
                    <a href="login.php" class="icon-logout"><i class="fa-solid fa-right-from-bracket"></i> Logout</a>
                </div>
            </div>
        </div>
