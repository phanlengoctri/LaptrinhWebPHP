...
<div class="product-detail-container">
    ...
    <div class="product-detail-info">
        ...
        <a class="add-to-card" href="product-detail.php?id=<?php echo $product['id']; ?>" onclick="addToCart(event, <?php echo $product['id']; ?>)">Thêm vào giỏ hàng</a>

        <button class="buy-now" onclick="buyNow(<?php echo $product['id']; ?>)">Mua ngay</button>
      <a href="products.php"> <button class="continue-buy">Tiếp tục mua hàng</button> </a>
        <div class="product-promotion">
            <h3>Khuyến mãi đặc biệt:</h3>
            <ul>
                <li>Tặng kèm 1 hộp đường phèn + 1 túi táo đỏ</li>
...
function addToCart(event, productId) {
    ...
    fetch('card.php?add_to_card=' + productId)
